...
def scrape_google_finance(ticker: str):
    ...
    ticker_data["ticker_data"]["quote"] = str(selector.css(".PdOqHc::text").get()).replace(" • ",":")
...
def nasdaq_get_timeseries_data():
    ...
    timeseries_data = nasdaqdatalink.get("WIKI/GOOGL", collapse="daily") # not sure what "WIKI" stands for
